...
async def test_get_token_transfers_by_address_integration(mock_ctx):
    ...
    result = await retry_on_network_error(
        lambda: get_token_transfers_by_address(
            chain_id="1",
            address=address,
            age_from=age_from,
        ...
        action_description="get_token_transfers_by_address request",
    )
...
async def test_get_token_transfers_by_address_pagination_integration(mock_ctx):
    ...
    first_page = await retry_on_network_error(
        ...
        action_description="get_token_transfers_by_address first page request",
    )
    ...
    second_page = await retry_on_network_error(
        ...
        action_description="get_token_transfers_by_address second page request",
    )
